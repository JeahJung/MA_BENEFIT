...
capture log close
log using "3.2.3 SSBCI-readmission EventStudyInteract w plan fe 3-17-2026.log", replace
*************************************************************************************
* Purpose: Use EventStudyInteract, run DiD model for Any expanded SSBCI for nondual & dual separately after baseline matching.
*          1. Overall
...
*             baseline_matched_SSBCI_nondual_frailty_11match_enrollee_stayer_readm
*             baseline_matched_SSBCI_dual_frailty_11match_enrollee_stayer_readm
* 3-17-2026 by Ge
*************************************************************************************
