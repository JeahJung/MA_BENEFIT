...
capture log close
log using "3.1.4 SSBCI-Create frailty dual baseline matched data 3-20-2026.log", replace
****************************************************************************************
* Purpose: To create baseline ps matching data for SSBCI and dual frailty only:
*          1-1 matching over the entire pre-period at enrollee level.
*          10% SD caliper but with common only
* Input file: did_anal_stayer
* Output file: baseline_matched_SSBCI_dual_frailty_11match_enrollee_stayer
* 3-17-2026 by Ge
****************************************************************************************
    ...
    isid BENE_ID year
    save "enrollee_SSBCI_dual_frailty_11match_stayer.dta", replace
    count
...
clear
gen BENE_ID = .
save "FINAL_matched_sample_SSBCI_dual_frailty.dta", replace emptyok
save "FINAL_matched_bene_list_SSBCI_dual_frailty.dta", replace emptyok   // only IDs, for later merge
...
gen cohort = 2020
save "temp_2020_SSBCI_dual_frailty.dta", replace

* Append to master files
use "FINAL_matched_sample_SSBCI_dual_frailty.dta", clear
append using "temp_2020_SSBCI_dual_frailty.dta"
save "FINAL_matched_sample_SSBCI_dual_frailty.dta", replace

use "temp_2020_SSBCI_dual_frailty.dta", clear
keep BENE_ID
duplicates drop
append using "FINAL_matched_bene_list_SSBCI_dual_frailty.dta"
save "FINAL_matched_bene_list_SSBCI_dual_frailty.dta", replace
...
gen cohort = 2021
save "temp_2021_SSBCI_dual_frailty.dta", replace

use "FINAL_matched_sample_SSBCI_dual_frailty.dta", clear
append using "temp_2021_SSBCI_dual_frailty.dta"
save "FINAL_matched_sample_SSBCI_dual_frailty.dta", replace

use "temp_2021_SSBCI_dual_frailty.dta", clear
keep BENE_ID
duplicates drop
append using "FINAL_matched_bene_list_SSBCI_dual_frailty.dta"
save "FINAL_matched_bene_list_SSBCI_dual_frailty.dta", replace
...
gen cohort = 2022
save "temp_2022_SSBCI_dual_frailty.dta", replace

use "FINAL_matched_sample_SSBCI_dual_frailty.dta", clear
append using "temp_2022_SSBCI_dual_frailty.dta"
save "FINAL_matched_sample_SSBCI_dual_frailty.dta", replace

use "temp_2022_SSBCI_dual_frailty.dta", clear
keep BENE_ID
duplicates drop
append using "FINAL_matched_bene_list_SSBCI_dual_frailty.dta"
save "FINAL_matched_bene_list_SSBCI_dual_frailty.dta", replace
...
erase temp_2020_SSBCI_dual_frailty.dta
erase temp_2021_SSBCI_dual_frailty.dta
erase temp_2022_SSBCI_dual_frailty.dta
...
********************************************************************************
use "FINAL_matched_bene_list_SSBCI_dual_frailty.dta", clear
duplicates report BENE_ID
duplicates drop BENE_ID, force
save "FINAL_matched_bene_list_CLEAN_SSBCI_dual_frailty.dta", replace

use "enrollee_SSBCI_dual_frailty_11match_stayer.dta", clear

* Keep ONLY the matched beneficiaries (treated + their controls)
merge m:1 BENE_ID using "FINAL_matched_bene_list_CLEAN_SSBCI_dual_frailty.dta", keep(match) nogen
...
save "baseline_matched_SSBCI_dual_frailty_11match_enrollee_stayer.dta", replace
count
tab treated
