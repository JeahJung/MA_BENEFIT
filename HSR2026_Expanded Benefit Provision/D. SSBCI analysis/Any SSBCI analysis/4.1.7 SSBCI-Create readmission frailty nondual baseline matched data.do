...
capture log close
log using "3.1.7 SSBCI-Create readmission frailty nondual baseline matched data 3-17-2026.log", replace
****************************************************************************************
...
* Output file: baseline_matched_SSBCI_nondual_frailty_11match_enrollee_stayer_readm
* 3-17-2026 by Ge
****************************************************************************************
    ...
    save "enrollee_SSBCI_nondual_frailty_11match_stayer_readm.dta", replace
    count
...
clear
gen BENE_ID = .
save "FINAL_matched_sample_SSBCI_nondual_frailty_readm.dta", replace emptyok
save "FINAL_matched_bene_list_SSBCI_nondual_frailty_readm.dta", replace emptyok   // only IDs, for later merge

********************************************************************************
* 2020 ADOPTERS - baseline year = 2019
********************************************************************************
use "enrollee_SSBCI_nondual_frailty_11match_stayer_readm.dta", clear
keep if year == 2019
...
gen cohort = 2020
save "temp_2020_SSBCI_nondual_frailty_readm.dta", replace

* Append to master files
use "FINAL_matched_sample_SSBCI_nondual_frailty_readm.dta", clear
append using "temp_2020_SSBCI_nondual_frailty_readm.dta"
save "FINAL_matched_sample_SSBCI_nondual_frailty_readm.dta", replace

use "temp_2020_SSBCI_nondual_frailty_readm.dta", clear
keep BENE_ID
duplicates drop
append using "FINAL_matched_bene_list_SSBCI_nondual_frailty_readm.dta"
save "FINAL_matched_bene_list_SSBCI_nondual_frailty_readm.dta", replace
...
gen cohort = 2021
save "temp_2021_SSBCI_nondual_frailty_readm.dta", replace

use "FINAL_matched_sample_SSBCI_nondual_frailty_readm.dta", clear
append using "temp_2021_SSBCI_nondual_frailty_readm.dta"
save "FINAL_matched_sample_SSBCI_nondual_frailty_readm.dta", replace

use "temp_2021_SSBCI_nondual_frailty_readm.dta", clear
keep BENE_ID
duplicates drop
append using "FINAL_matched_bene_list_SSBCI_nondual_frailty_readm.dta"
save "FINAL_matched_bene_list_SSBCI_nondual_frailty_readm.dta", replace
...
gen cohort = 2022
save "temp_2022_SSBCI_nondual_frailty_readm.dta", replace

use "FINAL_matched_sample_SSBCI_nondual_frailty_readm.dta", clear
append using "temp_2022_SSBCI_nondual_frailty_readm.dta"
save "FINAL_matched_sample_SSBCI_nondual_frailty_readm.dta", replace

use "temp_2022_SSBCI_nondual_frailty_readm.dta", clear
keep BENE_ID
duplicates drop
append using "FINAL_matched_bene_list_SSBCI_nondual_frailty_readm.dta"
save "FINAL_matched_bene_list_SSBCI_nondual_frailty_readm.dta", replace
...
erase temp_2020_SSBCI_nondual_frailty_readm.dta
erase temp_2021_SSBCI_nondual_frailty_readm.dta
erase temp_2022_SSBCI_nondual_frailty_readm.dta
...
********************************************************************************
use "FINAL_matched_bene_list_SSBCI_nondual_frailty_readm.dta", clear
duplicates report BENE_ID
duplicates drop BENE_ID, force
save "FINAL_matched_bene_list_CLEAN_SSBCI_nondual_frailty_readm.dta", replace

use "enrollee_SSBCI_nondual_frailty_11match_stayer_readm.dta", clear

* Keep ONLY the matched beneficiaries (treated + their controls)
merge m:1 BENE_ID using "FINAL_matched_bene_list_CLEAN_SSBCI_nondual_frailty_readm.dta", keep(match) nogen
...
save "baseline_matched_SSBCI_nondual_frailty_11match_enrollee_stayer_readm.dta", replace
count
tab treated
