...
capture log close
log using "5.3.1 GE 2 SSBCI-Descriptive overall unmatched & matched data 4-9-2026.log", replace
****************************************************************************************
...
gen BENE_ID = .
gen cohort = .
save "FINAL_unmatched_sample_SSBCI_nondual_ge2.dta", replace

clear
set obs 0
gen BENE_ID = .
save "FINAL_unmatched_bene_list_SSBCI_nondual_ge2.dta", replace
...
save "temp_2020_SSBCI_nondual_ge2_unmatched.dta", replace

use "FINAL_unmatched_sample_SSBCI_nondual_ge2.dta", clear
append using "temp_2020_SSBCI_nondual_ge2_unmatched.dta"
save "FINAL_unmatched_sample_SSBCI_nondual_ge2.dta", replace

use "temp_2020_SSBCI_nondual_ge2_unmatched.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_SSBCI_nondual_ge2.dta"
save "FINAL_unmatched_bene_list_SSBCI_nondual_ge2.dta", replace
...
save "temp_2021_SSBCI_nondual_ge2_unmatched.dta", replace

use "FINAL_unmatched_sample_SSBCI_nondual_ge2.dta", clear
append using "temp_2021_SSBCI_nondual_ge2_unmatched.dta"
save "FINAL_unmatched_sample_SSBCI_nondual_ge2.dta", replace

use "temp_2021_SSBCI_nondual_ge2_unmatched.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_SSBCI_nondual_ge2.dta"
save "FINAL_unmatched_bene_list_SSBCI_nondual_ge2.dta", replace
...
save "temp_2022_SSBCI_nondual_ge2_unmatched.dta", replace

use "FINAL_unmatched_sample_SSBCI_nondual_ge2.dta", clear
append using "temp_2022_SSBCI_nondual_ge2_unmatched.dta"
save "FINAL_unmatched_sample_SSBCI_nondual_ge2.dta", replace

use "temp_2022_SSBCI_nondual_ge2_unmatched.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_SSBCI_nondual_ge2.dta"
save "FINAL_unmatched_bene_list_SSBCI_nondual_ge2.dta", replace
...
**************************************************************************
use "FINAL_unmatched_bene_list_SSBCI_nondual_ge2.dta", clear
duplicates drop BENE_ID, force
save "FINAL_unmatched_bene_list_CLEAN_SSBCI_nondual_ge2.dta", replace
...
merge m:1 BENE_ID using "FINAL_unmatched_bene_list_CLEAN_SSBCI_nondual_ge2.dta", ///
    keep(match) nogen
...
save "baseline_unmatched_SSBCI_nondual_ge2_11match_enrollee_stayer.dta", replace

use "baseline_unmatched_SSBCI_nondual_ge2_11match_enrollee_stayer.dta", clear
...
gen BENE_ID = .
gen cohort = .
save "FINAL_unmatched_sample_SSBCI_dual_ge2.dta", replace

clear
set obs 0
gen BENE_ID = .
save "FINAL_unmatched_bene_list_SSBCI_dual_ge2.dta", replace
...
save "temp_2020_SSBCI_dual_ge2_unmatched.dta", replace

use "FINAL_unmatched_sample_SSBCI_dual_ge2.dta", clear
append using "temp_2020_SSBCI_dual_ge2_unmatched.dta"
save "FINAL_unmatched_sample_SSBCI_dual_ge2.dta", replace

use "temp_2020_SSBCI_dual_ge2_unmatched.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_SSBCI_dual_ge2.dta"
save "FINAL_unmatched_bene_list_SSBCI_dual_ge2.dta", replace
...
save "temp_2021_SSBCI_dual_ge2_unmatched.dta", replace

use "FINAL_unmatched_sample_SSBCI_dual_ge2.dta", clear
append using "temp_2021_SSBCI_dual_ge2_unmatched.dta"
save "FINAL_unmatched_sample_SSBCI_dual_ge2.dta", replace

use "temp_2021_SSBCI_dual_ge2_unmatched.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_SSBCI_dual_ge2.dta"
save "FINAL_unmatched_bene_list_SSBCI_dual_ge2.dta", replace
...
save "temp_2022_SSBCI_dual_ge2_unmatched.dta", replace

use "FINAL_unmatched_sample_SSBCI_dual_ge2.dta", clear
append using "temp_2022_SSBCI_dual_ge2_unmatched.dta"
save "FINAL_unmatched_sample_SSBCI_dual_ge2.dta", replace

use "temp_2022_SSBCI_dual_ge2_unmatched.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_SSBCI_dual_ge2.dta"
save "FINAL_unmatched_bene_list_SSBCI_dual_ge2.dta", replace
...
* STEP 2. Clean bene list
**************************************************************************
use "FINAL_unmatched_bene_list_SSBCI_dual_ge2.dta", clear
duplicates drop BENE_ID, force
save "FINAL_unmatched_bene_list_CLEAN_SSBCI_dual_ge2.dta", replace
...
merge m:1 BENE_ID using "FINAL_unmatched_bene_list_CLEAN_SSBCI_dual_ge2.dta", ///
    keep(match) nogen
...
save "baseline_unmatched_SSBCI_dual_ge2_11match_enrollee_stayer.dta", replace

use "baseline_unmatched_SSBCI_dual_ge2_11match_enrollee_stayer.dta", clear
