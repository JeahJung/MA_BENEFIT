...
capture log close
log using "5.3.2 GE 2 SSBCI-Descriptive readmission overall unmatched & matched data 4-9-2026.log", replace
****************************************************************************************
...
**************************************************************************
* STEP 1. Create baseline unmatched descriptive sample
*         one row per beneficiary, cohort-specific baseline year
**************************************************************************
...
gen BENE_ID = .
gen cohort = .
save "FINAL_unmatched_sample_SSBCI_nondual_ge2_readm.dta", replace

clear
set obs 0
gen BENE_ID = .
save "FINAL_unmatched_bene_list_SSBCI_nondual_ge2_readm.dta", replace
...
save "temp_2020_SSBCI_nondual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_SSBCI_nondual_ge2_readm.dta", clear
append using "temp_2020_SSBCI_nondual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_SSBCI_nondual_ge2_readm.dta", replace

use "temp_2020_SSBCI_nondual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_SSBCI_nondual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_SSBCI_nondual_ge2_readm.dta", replace
...
save "temp_2021_SSBCI_nondual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_SSBCI_nondual_ge2_readm.dta", clear
append using "temp_2021_SSBCI_nondual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_SSBCI_nondual_ge2_readm.dta", replace

use "temp_2021_SSBCI_nondual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_SSBCI_nondual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_SSBCI_nondual_ge2_readm.dta", replace
...
save "temp_2022_SSBCI_nondual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_SSBCI_nondual_ge2_readm.dta", clear
append using "temp_2022_SSBCI_nondual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_SSBCI_nondual_ge2_readm.dta", replace

use "temp_2022_SSBCI_nondual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_SSBCI_nondual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_SSBCI_nondual_ge2_readm.dta", replace
...
**************************************************************************
use "FINAL_unmatched_bene_list_SSBCI_nondual_ge2_readm.dta", clear
duplicates drop BENE_ID, force
save "FINAL_unmatched_bene_list_CLEAN_SSBCI_nondual_ge2_readm.dta", replace


**************************************************************************
* STEP 3. Create full unmatched panel for those beneficiaries
**************************************************************************
use "enrollee_SSBCI_nondual_ge2_unmatched_stayer_readm.dta", clear

merge m:1 BENE_ID using "FINAL_unmatched_bene_list_CLEAN_SSBCI_nondual_ge2_readm.dta", ///
    keep(match) nogen
...
save "baseline_unmatched_SSBCI_nondual_ge2_11match_enrollee_stayer_readm.dta", replace

use "baseline_unmatched_SSBCI_nondual_ge2_11match_enrollee_stayer_readm.dta", clear
...
* ============ Nondual matched ============
use baseline_matched_SSBCI_nondual_ge2_11match_enrollee_stayer_readm, clear
count
...
gen BENE_ID = .
gen cohort = .
save "FINAL_unmatched_sample_SSBCI_dual_ge2_readm.dta", replace

clear
set obs 0
gen BENE_ID = .
save "FINAL_unmatched_bene_list_SSBCI_dual_ge2_readm.dta", replace
...
save "temp_2020_SSBCI_dual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_SSBCI_dual_ge2_readm.dta", clear
append using "temp_2020_SSBCI_dual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_SSBCI_dual_ge2_readm.dta", replace

use "temp_2020_SSBCI_dual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_SSBCI_dual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_SSBCI_dual_ge2_readm.dta", replace
...
save "temp_2021_SSBCI_dual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_SSBCI_dual_ge2_readm.dta", clear
append using "temp_2021_SSBCI_dual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_SSBCI_dual_ge2_readm.dta", replace

use "temp_2021_SSBCI_dual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_SSBCI_dual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_SSBCI_dual_ge2_readm.dta", replace
...
save "temp_2022_SSBCI_dual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_SSBCI_dual_ge2_readm.dta", clear
append using "temp_2022_SSBCI_dual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_SSBCI_dual_ge2_readm.dta", replace

use "temp_2022_SSBCI_dual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_SSBCI_dual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_SSBCI_dual_ge2_readm.dta", replace
...
* STEP 2. Clean bene list
**************************************************************************
use "FINAL_unmatched_bene_list_SSBCI_dual_ge2_readm.dta", clear
duplicates drop BENE_ID, force
save "FINAL_unmatched_bene_list_CLEAN_SSBCI_dual_ge2_readm.dta", replace
...
merge m:1 BENE_ID using "FINAL_unmatched_bene_list_CLEAN_SSBCI_dual_ge2_readm.dta", ///
    keep(match) nogen
...
save "baseline_unmatched_SSBCI_dual_ge2_11match_enrollee_stayer_readm.dta", replace

use "baseline_unmatched_SSBCI_dual_ge2_11match_enrollee_stayer_readm.dta", clear
...
* ============ Dual matched ============
use baseline_matched_SSBCI_dual_ge2_11match_enrollee_stayer_readm, clear
count
