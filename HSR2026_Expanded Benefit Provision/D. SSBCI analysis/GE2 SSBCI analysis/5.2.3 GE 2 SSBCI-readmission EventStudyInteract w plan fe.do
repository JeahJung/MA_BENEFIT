...
capture log close
log using "5.2.3 GE 2 SSBCI-readmission EventStudyInteract w plan fe 3-18-2026.log", replace
*************************************************************************************
* Purpose: Use both xtreg and EventStudyInteract, run DiD model for Any expanded SSBCI for nondual & dual separately after baseline matching.
*          1. Overall
*          2. Limit to top frailty scores (frailty tertile)
* Input file: baseline_matched_SSBCI_nondual_ge2_11match_enrollee_stayer_readm
*             baseline_matched_SSBCI_dual_ge2_11match_enrollee_stayer_readm
*             baseline_matched_SSBCI_nondual_frailty_ge2_11match_enrollee_stayer_readm
*             baseline_matched_SSBCI_dual_frailty_ge2_11match_enrollee_stayer_readm
* 3-18-2026 by Ge
*************************************************************************************
...
forvalues t = -5/2 {
    ...
    eventstudyinteract readm_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_SSBCI) control_cohort(never_SSBCI) covariates($supp_benefit $X $condition) absorb(i.plan_fe i.year) vce(cluster plan_fe)
...
forvalues t = -5/2 {
    ...
    di "************ Matched Non-Dual limit to frailty eventstudyinteract - readm of Any SSBCI ************"
    eventstudyinteract readm_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_SSBCI) control_cohort(never_SSBCI) covariates($supp_benefit $X $condition) absorb(i.plan_fe i.year) vce(cluster plan_fe)
...
di "************ Matched Dual limit to frailty eventstudyinteract - readm of Any SSBCI ************"
    eventstudyinteract readm_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_SSBCI) control_cohort(never_SSBCI) covariates($supp_benefit $X $condition) absorb(i.plan_fe i.year) vce(cluster plan_fe)
