...
capture log close
log using "5.2.6 GE 2 SSBCI-honestdid wider x-axis 3-27-2026.log", replace
*************************************************************************************
...
*             baseline_matched_SSBCI_nondual_ge2_11match_enrollee_readm
*             baseline_matched_SSBCI_dual_ge2_11match_enrollee_readm
*             baseline_matched_SSBCI_nondual_frailty_ge2_11match_enrollee_readm
*             baseline_matched_SSBCI_dual_frailty_ge2_11match_enrollee_readm
* 3-27-2026 by Ge
*************************************************************************************
...
forvalues t = -5/2 {
    ...
    * Average post effect (n-weighted over 3 post periods):
    ...
    preserve
        ...
        graph export "ge2_SSBCI_nondual_ED_2.png", replace
    restore
    ...
    * Average post effect (n-weighted over 3 post periods):
    ...
    preserve
        ...
        graph export "ge2_SSBCI_nondual_IP_2.png", replace
    restore
...
forvalues t = -5/2 {
    ...
    * Average post effect (n-weighted over 3 post periods):
    ...
    preserve
        ...
        graph export "ge2_SSBCI_nondual_frailty_ED_2.png", replace
    restore
    ...
    * Average post effect (n-weighted over 3 post periods):
    ...
    preserve
        ...
        graph export "ge2_SSBCI_nondual_frailty_IP_2.png", replace
    restore
...
di "************ Matched Dual eventstudyinteract - ED of Any SSBCI ************"
    ...
    * Average post effect (n-weighted over 3 post periods):
    ...
    preserve
        ...
        graph export "ge2_SSBCI_dual_ED_2.png", replace
    restore
...
di "************ Matched Dual eventstudyinteract - IP of Any SSBCI ************"
    ...
    * Average post effect (n-weighted over 3 post periods):
    ...
    preserve
        ...
        graph export "ge2_SSBCI_dual_IP_2.png", replace
    restore
...
di "************ Matched Dual frailty eventstudyinteract - ED of Any SSBCI ************"
    ...
    * Average post effect (n-weighted over 3 post periods):
    ...
    preserve
        ...
        graph export "ge2_SSBCI_dual_frailty_ED_2.png", replace
    restore
...
di "************ Matched Dual frailty eventstudyinteract - IP of Any SSBCI ************"
    ...
    * Average post effect (n-weighted over 3 post periods):
    ...
    preserve
        ...
        graph export "ge2_SSBCI_dual_frailty_IP_2.png", replace
    restore
...
forvalues t = -5/2 {
    ...
    * Average post effect (n-weighted over 3 post periods):
    ...
    preserve
        ...
        graph export "ge2_SSBCI_nondual_readm_2.png", replace
    restore
...
forvalues t = -5/2 {
    ...
    * Average post effect (n-weighted over 3 post periods):
    ...
    preserve
        ...
        graph export "ge2_SSBCI_nondual_frailty_readm_2.png", replace
    restore
...
di "************ Matched Dual eventstudyinteract - readm of Any SSBCI ************"
    ...
    * Average post effect (n-weighted over 3 post periods):
    ...
    preserve
        ...
        graph export "ge2_SSBCI_dual_readm_2.png", replace
    restore
...
di "************ Matched Dual frailty eventstudyinteract - readm of Any SSBCI ************"
    ...
    * Average post effect (n-weighted over 3 post periods):
    ...
    preserve
        ...
        graph export "ge2_SSBCI_dual_frailty_readm_2.png", replace
    restore
