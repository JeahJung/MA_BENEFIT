...
capture log close
log using "2.2.3 PHR-readmission EventStudyInteract w plan FE 3-17-2026.log", replace
*************************************************************************************
...
forvalues t = -5/3 {
    ...
    xtreg readm_ind trt_post_PHR $supp_benefit $X $condition i.year2018 i.year2019 i.year2020 i.year2021 i.year2022, fe vce(cl plan_fe) 
