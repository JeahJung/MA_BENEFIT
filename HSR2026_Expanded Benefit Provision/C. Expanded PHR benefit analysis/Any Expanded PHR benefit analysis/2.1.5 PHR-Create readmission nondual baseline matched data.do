...
capture log close
log using "2.1.5 PHR-Create readmission nondual baseline matched data 3-17-2026.log", replace
****************************************************************************************
* Purpose: To create baseline ps matching data for PHR nondual only with complete contracts for readmission:
...
* Output file: baseline_matched_PHR_nondual_11match_enrollee_stayer_readm
* 3-17-2026 by Ge
****************************************************************************************
...
save "enrollee_PHR_nondual_11match_stayer_readm.dta", replace


* Empty final files
clear
gen BENE_ID = .
save "FINAL_matched_sample_PHR_nondual_readm.dta", replace emptyok
save "FINAL_matched_bene_list_PHR_nondual_readm.dta", replace emptyok

********************************************************************************
* 2019 ADOPTERS - baseline year = 2018
********************************************************************************
use "enrollee_PHR_nondual_11match_stayer_readm.dta", clear
keep if year == 2018
...
gen cohort = 2019
save "temp_PHR_nondual_readm.dta", replace

use "FINAL_matched_sample_PHR_nondual_readm.dta", clear
append using "temp_PHR_nondual_readm.dta"
save "FINAL_matched_sample_PHR_nondual_readm.dta", replace

use "temp_PHR_nondual_readm.dta", clear
keep BENE_ID
append using "FINAL_matched_bene_list_PHR_nondual_readm.dta"
save "FINAL_matched_bene_list_PHR_nondual_readm.dta", replace
erase "temp_PHR_nondual_readm.dta"
...
********************************************************************************
use "FINAL_matched_bene_list_PHR_nondual_readm.dta", clear
duplicates report BENE_ID
duplicates drop BENE_ID, force
save "FINAL_matched_bene_list_CLEAN_PHR_nondual_readm.dta", replace

use "enrollee_PHR_nondual_11match_stayer_readm.dta", clear

* Keep ONLY the matched beneficiaries (treated + their controls)
merge m:1 BENE_ID using "FINAL_matched_bene_list_CLEAN_PHR_nondual_readm.dta", keep(match) nogen
...
save "baseline_matched_PHR_nondual_11match_enrollee_stayer_readm.dta", replace
count
tab treated
