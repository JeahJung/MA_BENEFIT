...
capture log close
log using "2.2.4 PHR-readmission EventStudyInteract w plan county FE 3-17-2026.log", replace
*************************************************************************************
* Purpose: Use EventStudyInteract, run DiD model for readmission Any PHR for nondual & dual separately after baseline matching.
*          1. Overall
*          2. Limit to top frailty scores (frailty tertile)
* Also get weighted average of pre-period and F-test for parallel trend test
...
************ weighted average for pre-period parallel trend test
    ...
    * n-weighted average pre-treatment effect over pre periods
...
forvalues t = -5/3 {
    ...
    di "********** Matched Dual limit to frailty TWFE DiD - readm of Any PHR **********"
    xtreg readm_ind trt_post_PHR $supp_benefit $X $condition i.year2018 i.year2019 i.year2020 i.year2021 i.year2022, fe vce(cl plan_county) 
