...
capture log close
log using "2.1.1 PHR-Create 11 match nondual baseline matched data 3-16-2026.log", replace
****************************************************************************************
...
* Output file: baseline_matched_PHR_nondual_11match_enrollee_stayer
* 3-16-2026 by Ge
****************************************************************************************
...
isid BENE_ID year
save "enrollee_PHR_nondual_11match_stayer.dta", replace


* Empty final files
clear
gen BENE_ID = .
save "FINAL_matched_sample_PHR_nondual.dta", replace emptyok
save "FINAL_matched_bene_list_PHR_nondual.dta", replace emptyok

********************************************************************************
* 2019 ADOPTERS - baseline year = 2018
********************************************************************************
use "enrollee_PHR_nondual_11match_stayer.dta", clear
keep if year == 2018
...
gen cohort = 2019
save "temp_PHR_nondual.dta", replace

use "FINAL_matched_sample_PHR_nondual.dta", clear
append using "temp_PHR_nondual.dta"
save "FINAL_matched_sample_PHR_nondual.dta", replace

use "temp_PHR_nondual.dta", clear
keep BENE_ID
append using "FINAL_matched_bene_list_PHR_nondual.dta"
save "FINAL_matched_bene_list_PHR_nondual.dta", replace
erase "temp_PHR_nondual.dta"
...
********************************************************************************
use "FINAL_matched_bene_list_PHR_nondual.dta", clear
duplicates report BENE_ID
duplicates drop BENE_ID, force
save "FINAL_matched_bene_list_CLEAN_PHR_nondual.dta", replace

use "enrollee_PHR_nondual_11match_stayer.dta", clear

* Keep ONLY the matched beneficiaries (treated + their controls)
merge m:1 BENE_ID using "FINAL_matched_bene_list_CLEAN_PHR_nondual.dta", keep(match) nogen
...
save "baseline_matched_PHR_nondual_11match_enrollee_stayer.dta", replace
count
