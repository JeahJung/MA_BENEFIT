...
capture log close
log using "2.2.2 PHR-ED IP EventStudyInteract w plan county FE 3-20-2026.log", replace
*************************************************************************************
* Purpose: Use both TWFE and EventStudyInteract, run DiD model for Any expanded PHR for nondual & dual separately after baseline matching.
*          1. Overall
