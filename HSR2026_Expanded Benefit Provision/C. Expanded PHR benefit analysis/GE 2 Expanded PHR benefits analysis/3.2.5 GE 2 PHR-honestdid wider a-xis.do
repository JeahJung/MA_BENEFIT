...
capture log close
log using "4.2.6 GE 2 PHR-honestdid wider x-axis 3-27-2026.log", replace
*************************************************************************************
...
*             baseline_matched_PHR_nondual_ge2_11match_enrollee_stayer_readm
...
forvalues t = -5/3 {
    ...
    * Average post effect (n-weighted over 4 post periods):
    ...
    preserve
        ...
        graph export "ge2_PHR_nondual_ED_2.png", replace
    restore
    ...
    * Average post effect (n-weighted over 4 post periods):
    ...
    preserve
        ...
        graph export "ge2_PHR_nondual_IP_2.png", replace
    restore
...
forvalues t = -5/3 {
    ...
    * Average post effect (n-weighted over 4 post periods):
    ...
    preserve
        ...
        graph export "ge2_PHR_nondual_frailty_ED_2.png", replace
    restore
    ...
    * Average post effect (n-weighted over 4 post periods):
    ...
    preserve
        ...
        graph export "ge2_PHR_nondual_frailty_IP_2.png", replace
    restore
...
forvalues t = -5/3 {
    ...
    * Average post effect (n-weighted over 4 post periods):
    ...
    preserve
        ...
        graph export "ge2_PHR_dual_ED_2.png", replace
    restore
    ...
    * Average post effect (n-weighted over 4 post periods):
    ...
    preserve
        ...
        graph export "ge2_PHR_dual_IP_2.png", replace
    restore
...
forvalues t = -5/3 {
    ...
    * Average post effect (n-weighted over 4 post periods):
    ...
    preserve
        ...
        graph export "ge2_PHR_dual_frailty_ED_2.png", replace
    restore
    ...
    * Average post effect (n-weighted over 4 post periods):
    ...
    preserve
        ...
        graph export "ge2_PHR_dual_frailty_IP_2.png", replace
    restore
...
forvalues t = -5/3 {
    ...
    * Average post effect (n-weighted over 4 post periods):
    ...
    preserve
        ...
        graph export "ge2_PHR_nondual_readm_2.png", replace
    restore
...
forvalues t = -5/3 {
    ...
    * Average post effect (n-weighted over 4 post periods):
    ...
    preserve
        ...
        graph export "ge2_PHR_nondual_frailty_readm_2.png", replace
    restore
...
di "************ Matched Dual eventstudyinteract - readm of Any PHR ************"
    ...
    * Average post effect (n-weighted over 4 post periods):
    ...
    preserve
        ...
        graph export "ge2_PHR_dual_readm_2.png", replace
    restore
...
di "************ Matched Dual frailty eventstudyinteract - readm of Any Expanded PHR ************"
    ...
    * Average post effect (n-weighted over 4 post periods):
    ...
    preserve
        ...
        graph export "ge2_PHR_dual_frailty_readm_2.png", replace
    restore
