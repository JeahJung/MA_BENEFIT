...
capture log close
log using "4.3.3 GE 2 PHR-Descriptive overall readmission unmatched & matched data 4-9-2026.log", replace
****************************************************************************************
...
gen BENE_ID = .
gen cohort = .
save "FINAL_unmatched_sample_PHR_nondual_ge2_readm.dta", replace

clear
set obs 0
gen BENE_ID = .
save "FINAL_unmatched_bene_list_PHR_nondual_ge2_readm.dta", replace
...
save "temp_2019_PHR_nondual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_PHR_nondual_ge2_readm.dta", clear
append using "temp_2019_PHR_nondual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_PHR_nondual_ge2_readm.dta", replace

use "temp_2019_PHR_nondual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_PHR_nondual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_PHR_nondual_ge2_readm.dta", replace
...
save "temp_2020_PHR_nondual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_PHR_nondual_ge2_readm.dta", clear
append using "temp_2020_PHR_nondual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_PHR_nondual_ge2_readm.dta", replace

use "temp_2020_PHR_nondual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_PHR_nondual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_PHR_nondual_ge2_readm.dta", replace
...
save "temp_2021_PHR_nondual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_PHR_nondual_ge2_readm.dta", clear
append using "temp_2021_PHR_nondual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_PHR_nondual_ge2_readm.dta", replace

use "temp_2021_PHR_nondual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_PHR_nondual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_PHR_nondual_ge2_readm.dta", replace
...
save "temp_2022_PHR_nondual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_PHR_nondual_ge2_readm.dta", clear
append using "temp_2022_PHR_nondual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_PHR_nondual_ge2_readm.dta", replace

use "temp_2022_PHR_nondual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_PHR_nondual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_PHR_nondual_ge2_readm.dta", replace
...
**************************************************************************
use "FINAL_unmatched_bene_list_PHR_nondual_ge2_readm.dta", clear
duplicates drop BENE_ID, force
save "FINAL_unmatched_bene_list_CLEAN_PHR_nondual_ge2_readm.dta", replace
...
merge m:1 BENE_ID using "FINAL_unmatched_bene_list_CLEAN_PHR_nondual_ge2_readm.dta", ///
    keep(match) nogen
...
save "baseline_unmatched_PHR_nondual_ge2_11match_enrollee_stayer_readm.dta", replace

use "baseline_unmatched_PHR_nondual_ge2_11match_enrollee_stayer_readm.dta", clear
...
gen BENE_ID = .
gen cohort = .
save "FINAL_unmatched_sample_PHR_dual_ge2_readm.dta", replace

clear
set obs 0
gen BENE_ID = .
save "FINAL_unmatched_bene_list_PHR_dual_ge2_readm.dta", replace
...
save "temp_2019_PHR_dual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_PHR_dual_ge2_readm.dta", clear
append using "temp_2019_PHR_dual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_PHR_dual_ge2_readm.dta", replace

use "temp_2019_PHR_dual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_PHR_dual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_PHR_dual_ge2_readm.dta", replace
...
save "temp_2020_PHR_dual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_PHR_dual_ge2_readm.dta", clear
append using "temp_2020_PHR_dual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_PHR_dual_ge2_readm.dta", replace

use "temp_2020_PHR_dual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_PHR_dual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_PHR_dual_ge2_readm.dta", replace
...
save "temp_2021_PHR_dual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_PHR_dual_ge2_readm.dta", clear
append using "temp_2021_PHR_dual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_PHR_dual_ge2_readm.dta", replace

use "temp_2021_PHR_dual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_PHR_dual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_PHR_dual_ge2_readm.dta", replace
...
save "temp_2022_PHR_dual_ge2_unmatched_readm.dta", replace

use "FINAL_unmatched_sample_PHR_dual_ge2_readm.dta", clear
append using "temp_2022_PHR_dual_ge2_unmatched_readm.dta"
save "FINAL_unmatched_sample_PHR_dual_ge2_readm.dta", replace

use "temp_2022_PHR_dual_ge2_unmatched_readm.dta", clear
keep BENE_ID
duplicates drop BENE_ID, force
append using "FINAL_unmatched_bene_list_PHR_dual_ge2_readm.dta"
save "FINAL_unmatched_bene_list_PHR_dual_ge2_readm.dta", replace
...
* STEP 2. Clean bene list
**************************************************************************
use "FINAL_unmatched_bene_list_PHR_dual_ge2_readm.dta", clear
duplicates drop BENE_ID, force
save "FINAL_unmatched_bene_list_CLEAN_PHR_dual_ge2_readm.dta", replace
...
merge m:1 BENE_ID using "FINAL_unmatched_bene_list_CLEAN_PHR_dual_ge2_readm.dta", ///
    keep(match) nogen
...
save "baseline_unmatched_PHR_dual_ge2_11match_enrollee_stayer_readm.dta", replace

use "baseline_unmatched_PHR_dual_ge2_11match_enrollee_stayer_readm.dta", clear
