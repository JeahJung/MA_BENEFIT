...
capture log close
log using "7.2.1 FS-ED IP EventStudyInteract w plan fe 3-22-2026.log", replace
*************************************************************************************
...
foreach y in $outcome {
    ...
    eventstudyinteract `y'_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_FS) control_cohort(never_FS) covariates($supp_benefit $X $condition) absorb(i.plan_fe i.year) vce(cluster plan_fe)
