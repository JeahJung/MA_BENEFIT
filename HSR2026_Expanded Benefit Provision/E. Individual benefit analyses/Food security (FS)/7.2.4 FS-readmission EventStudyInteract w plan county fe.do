...
capture log close
log using "7.2.4 FS-readmission EventStudyInteract w plan county fe 3-22-2026.log", replace
*************************************************************************************
* Purpose: Use EventStudyInteract, run DiD model for FS for nondual & dual separately after baseline matching.
*          1. Overall
*          2. Limit to top frailty scores (frailty tertile)
* Input file: baseline_matched_FS_nondual_11match_enrollee_stayer_readm
*             baseline_matched_FS_dual_11match_enrollee_stayer_readm
*             baseline_matched_FS_nondual_frailty_11match_enrollee_stayer_readm
*             baseline_matched_FS_dual_11match_frailty_enrollee_stayer_readm
* 3-22-2026 by Ge
*************************************************************************************
...
forvalues t = -5/2 {
    ...
    di "************ Matched Non-Dual eventstudyinteract - readm of Any FS ************"
...
di "************ Matched Dual eventstudyinteract - readm of Any FS ************"
    eventstudyinteract readm_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_FS) control_cohort(never_FS) covariates($supp_benefit $X $condition) absorb(i.plan_county i.year) vce(cluster plan_county)
...
forvalues t = -5/2 {
    ...
    di "************ Matched Non-Dual limit to frailty eventstudyinteract - readm of Any FS ************"
    eventstudyinteract readm_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_FS) control_cohort(never_FS) covariates($supp_benefit $X $condition) absorb(i.plan_county i.year) vce(cluster plan_county)
...
di "************ Matched Dual limit to frailty eventstudyinteract - readm of Any FS ************"
    eventstudyinteract readm_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_FS) control_cohort(never_FS) covariates($supp_benefit $X $condition) absorb(i.plan_county i.year) vce(cluster plan_county)
