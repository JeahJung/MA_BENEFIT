...
capture log close
log using "7.2.3 FS-readmission EventStudyInteract w plan fe 3-22-2026.log", replace
*************************************************************************************
...
bysort plan_fe: egen g_FS = min(cond(trt_post_FS==1, year, .))
...
forvalues t = -5/2 {
    ...
    eventstudyinteract readm_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_FS) control_cohort(never_FS) covariates($supp_benefit $X $condition) absorb(i.plan_fe i.year) vce(cluster plan_fe)
