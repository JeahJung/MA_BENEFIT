...
capture log close
log using "7.2.2 FS-ED IP EventStudyInteract w plan county fe 3-22-2026.log", replace
*************************************************************************************
...
foreach y in $outcome {
    ...
    di "************ Matched Non-Dual eventstudyinteract - `y' of FS ************"
    eventstudyinteract `y'_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_FS) control_cohort(never_FS) covariates($supp_benefit $X $condition) absorb(i.plan_county i.year) vce(cluster plan_county)
...
di "************ Matched Dual eventstudyinteract - `y' of FS ************"
    eventstudyinteract `y'_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_FS) control_cohort(never_FS) covariates($supp_benefit $X $condition) absorb(i.plan_county i.year) vce(cluster plan_county)
...
foreach y in $outcome {
    ...
    di "************ Matched Non-Dual limit to frailty eventstudyinteract - `y' of FS ************"
    eventstudyinteract `y'_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_FS) control_cohort(never_FS) covariates($supp_benefit $X $condition) absorb(i.plan_county i.year) vce(cluster plan_county)
...
di "************ Matched Dual limit to frailty eventstudyinteract - `y' of FS ************"
    eventstudyinteract `y'_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_FS) control_cohort(never_FS) covariates($supp_benefit $X $condition) absorb(i.plan_county i.year) vce(cluster plan_county)
