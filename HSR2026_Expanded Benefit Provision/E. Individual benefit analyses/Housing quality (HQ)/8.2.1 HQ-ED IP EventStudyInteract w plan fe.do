...
capture log close
log using "8.2.1 HQ-ED IP EventStudyInteract w plan fe 3-22-2026.log", replace
*************************************************************************************
...
foreach y in $outcome {
    ...
    eventstudyinteract `y'_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_HQ) control_cohort(never_HQ) covariates($supp_benefit $X $condition) absorb(i.plan_fe i.year) vce(cluster plan_fe)
