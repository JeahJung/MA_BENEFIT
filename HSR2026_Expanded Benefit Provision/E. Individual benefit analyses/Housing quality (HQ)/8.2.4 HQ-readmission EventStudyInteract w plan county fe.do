...
capture log close
log using "8.2.4 HQ-readmission EventStudyInteract w plan county fe 3-22-2026.log", replace
*************************************************************************************
* Purpose: Use both xtreg and EventStudyInteract, run DiD model for HQ for nondual & dual separately after baseline matching.
*          1. Overall
*          2. Limit to top frailty scores (frailty tertile)
* Input file: baseline_matched_HQ_nondual_11match_enrollee_stayer_readm
*             baseline_matched_HQ_dual_11match_enrollee_stayer_readm
*             baseline_matched_HQ_nondual_frailty_11match_enrollee_stayer_readm
*             baseline_matched_HQ_dual_frailty_11match_enrollee_stayer_readm
* 3-22-2026 by Ge
*************************************************************************************
...
forvalues t = -5/2 {
    ...
    di "************ Matched Non-Dual limit to frailty eventstudyinteract - readm of HQ ************"
    eventstudyinteract readm_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_HQ) control_cohort(never_HQ) covariates($supp_benefit $X $condition) absorb(i.plan_county i.year) vce(cluster plan_county)
...
di "************ Matched Dual limit to frailty eventstudyinteract - readm of HQ ************"
    eventstudyinteract readm_ind M_5 M_4 M_3 M_2 P_0 P_1 P_2, cohort(g_HQ) control_cohort(never_HQ) covariates($supp_benefit $X $condition) absorb(i.plan_county i.year) vce(cluster plan_county)
