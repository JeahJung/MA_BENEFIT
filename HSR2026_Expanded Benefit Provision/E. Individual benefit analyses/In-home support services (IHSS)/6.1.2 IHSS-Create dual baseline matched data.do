...
capture log close
log using "6.1.2 IHSS-Create dual baseline matched data 3-22-2026.log", replace
****************************************************************************************
...
* Output file: baseline_matched_IHSS_dual_11match_enrollee_stayer
* 3-22-2026 by Ge
****************************************************************************************
...
isid BENE_ID year
save "enrollee_IHSS_dual_11match_stayer.dta", replace


* Empty final files
clear
gen BENE_ID = .
save "FINAL_matched_sample_IHSS_dual.dta", replace emptyok
save "FINAL_matched_bene_list_IHSS_dual.dta", replace emptyok

********************************************************************************
* 2019 ADOPTERS - baseline year = 2018
********************************************************************************
use "enrollee_IHSS_dual_11match_stayer.dta", clear
keep if year == 2018
...
gen cohort = 2019
save "temp_IHSS_dual.dta", replace

use "FINAL_matched_sample_IHSS_dual.dta", clear
append using "temp_IHSS_dual.dta"
save "FINAL_matched_sample_IHSS_dual.dta", replace

use "temp_IHSS_dual.dta", clear
keep BENE_ID
append using "FINAL_matched_bene_list_IHSS_dual.dta"
save "FINAL_matched_bene_list_IHSS_dual.dta", replace
erase "temp_IHSS_dual.dta"
...
********************************************************************************
use "FINAL_matched_bene_list_IHSS_dual.dta", clear
duplicates report BENE_ID
duplicates drop BENE_ID, force
save "FINAL_matched_bene_list_CLEAN_IHSS_dual.dta", replace

use "enrollee_IHSS_dual_11match_stayer.dta", clear

* Keep ONLY the matched beneficiaries (treated + their controls)
merge m:1 BENE_ID using "FINAL_matched_bene_list_CLEAN_IHSS_dual.dta", keep(match) nogen
...
save "baseline_matched_IHSS_dual_11match_enrollee_stayer.dta", replace
count
tab treated
